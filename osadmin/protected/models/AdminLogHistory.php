...
class AdminLogHistory extends CActiveRecord
{
	...
	{
		return array(
			'access_date' => yii::t('adminloghistories','entry_access_date'),
			'id_admin' => yii::t('adminloghistories','entry_id_admin'),
			'page_accessed' => yii::t('adminloghistories','entry_page_accessed'),
			 
			'page_url' =>yii::t('adminloghistories','entry_page_url'),
			'action' => yii::t('adminloghistories','entry_action'),
			'ip_address' => yii::t('adminloghistories','entry_ip_address'),
		);
	}
