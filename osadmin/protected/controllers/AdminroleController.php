...
class AdminroleController extends Controller
{
        public function getAdminPermissions()
        {
            ...
            foreach($rows as $row)
            {
                $modules[$row->module_name][]=array('file'=>array("file_name"=>$row->file_name,"view"=>$row->view,"add"=>$row->add,"edit"=>$row->edit,"trash"=>$row->trash,"file_sort_order"=>$row->file_sort_order),'menu_type'=>$row->menu_type,"module_sort_order"=>$row->module_sort_order);
            }
            return $modules;
            /*echo '<pre>';
            print_r($modules);
