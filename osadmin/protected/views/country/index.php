    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'name', 'header' => Yii::t('countries',
                            'column_name'), 'value' => '$data->name'),
                array('name' => 'zone_search', 'header' => Yii::t('countries',
                            'column_zone_search'), 'value' => '$data->zone->name'),
                array('name' => 'iso_code_2', 'header' => Yii::t('countries',
                            'column_iso_code_2'), 'value' => '$data->iso_code_2'),
                array('name' => 'iso_code_3', 'header' => Yii::t('countries','column_iso_code_3'), 'value' => '$data->iso_code_3'),
                array('name' => 'status', 'header' => Yii::t('countries','column_status'),
                    'filter' => CHtml::dropDownList('Country[status]',
                            $_GET['Country']['status'],
