    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'name', 'header' => Yii::t('categories','column_name'), 'value' => array($this,'grid')),
                array('name'=>'status', 'header'=>Yii::t('categories','column_status'),           
					'filter'=>CHtml::dropDownList('Category[status]', $_GET['Category']['status'],  
