            ...
            <div class="span12">
                <fieldset class="portlet " >
                     <div class="portlet-decoration arrow-minus" onclick=" $('#hide_box_line1').slideToggle();">
                        <div class="span11">Best Seller</div>
                  ...
                  //      echo "Name : ".CHtml::textField('data[name]', $data['data']['name']);
                    ...
                    <div class="span12 pull-right" id="attribute">
                        ...
                        <table class="table">
                            <thead>
                                <tr> 
									<th style="width: 12%"><?php echo  Yii::t('modules','entry_limit')?></th>
                                    <th style="width: 24%"><?php echo  Yii::t('modules','entry_image')?></th>
                                    <th style="width: 20%"><?php echo  Yii::t('modules','entry_layout')?></th>
                                    <th style="width: 20%"><?php echo  Yii::t('modules','entry_position')?></th>
                                    <th style="width: 9%"><?php echo  Yii::t('modules','entry_sort_order')?></th>
                            ...
                            foreach ($data['module'] as $input):
                                ...
                                <tbody id='row-<?php echo $row; ?>'>
                                    <tr >
										...
										<td><?php echo CHtml::textField('module[' . $row . '][height]', $input['height'] ,array('class'=>'span5')); ?><?php echo CHtml::textField('module[' . $row . '][width]', $input['width'], array('class'=>'span5')); ?></td>
                                        <td>
