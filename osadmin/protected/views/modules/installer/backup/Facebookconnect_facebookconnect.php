            ...
            <div class="span12">
                <fieldset class="portlet " >
                     <div class="portlet-decoration arrow-minus" onclick=" $('#hide_box_line1').slideToggle();">
                        <div class="span11"><?php echo Yii::t('modules','heading_title_facebookconnect')?></div>
                        <div class="span1 Dev-arrow"><button class="btn btn-info arrow_main" type="button"></button> </div>
                        <div class="clearfix"></div>	
                    </div>
                    <div class="portlet-content" id="hide_box_line1">
                       <div class="span6 design-inspan"> <?php echo "Facebook API Key   : ".CHtml::textField('data[key]', $data['data']['key']); ?> </div>  <div class="span6 design-inspan">  <?php echo "Facebook API Secret: ".CHtml::textField('data[secret]', $data['data']['secret']); ?> </div>  <div class="span6 design-inspan"> <?php echo "Connect Button     : ".CHtml::textField('data[button]', $data['data']['button']); ?> </div>
                    ...
                    <div class="span12 pull-right" id="attribute">
                        ...
                        $box = $this->beginWidget(
                                ...
                                array(
                          'title' => Yii::t('modules','entry_add_edit'),
