            ...
            <div class="span12">
                <fieldset class="portlet " >
                     <div class="portlet-decoration arrow-minus" onclick=" $('#hide_box_line1').slideToggle();">
                        <div class="span11">Recently Viewed  </div>
                  ...
                  //      echo "Name : ".CHtml::textField('data[name]', $data['data']['name']);
                    ...
                    <div class="span12 pull-right" id="attribute">
                        ...
                        $box = $this->beginWidget(
                                ...
                                array(
                            'title' => 'Add/Edit Recently Viewed Module',
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 16%"><?php echo  Yii::t('modules','entry_sort_order')?></th>
                                    <th style="width: 18%"><?php echo  Yii::t('modules','entry_status')?></th>
...
<?php $this->endWidget();                             
    ...
    <script type='text/javascript'>
        ...
        function addModule()
        {
			...
			row += '<td><input  type="text" name="module[' + row_no + '][height]" value="" maxlength="100"  class="span5"><input  type="text" name="module[' + row_no + '][width]" value="" maxlength="100" class="span5"></td>';
