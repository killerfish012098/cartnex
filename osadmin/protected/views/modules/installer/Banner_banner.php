            ...
            <div class="span12">
                <fieldset class="portlet " >
                     <div class="portlet-decoration arrow-minus" onclick=" $('#hide_box_line1').slideToggle();">
                        <div class="span11"><?php echo Yii::t('modules','heading_title_banner')?>  </div>
                    ...
                    <div class="span12 pull-right" id="attribute">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="width: 16%"><?php echo  Yii::t('modules','entry_banner')?></th>
                                    <th style="width: 8%"><?php echo  Yii::t('modules','entry_box_size')?></th>
                                    <th style="width: 20%"><?php echo  Yii::t('modules','entry_image')?></th>
                                    <th style="width: 20%"><?php echo  Yii::t('modules','entry_layout')?></th>
                                    <th style="width: 15%"><?php echo  Yii::t('modules','entry_position')?></th>
                                    <th style="width: 8%"><?php echo  Yii::t('modules','entry_sort_order')?></th>
                                    <th style="width: 16%"><?php echo  Yii::t('modules','entry_status')?></th>
                                    <th style="width: 9%"><?php echo  Yii::t('modules','entry_action')?></th>
                                </tr>
                            </thead>
                            ...
                            foreach ($data['module'] as $input):
                                ...
                                <tbody id='row-<?php echo $row; ?>'>
                                    <tr >
                                        ...
                                        <td >
                                            <?php echo CHtml::dropDownList('module[' . $row . '][layout]', $input['layout'],Library::getLayouts());?></td>
