	...
	'columns'=>array(
     array(
        ...
        'value'=>'$this->grid->dataProvider->pagination->currentPage * $this->grid->dataProvider->pagination->pageSize + ($row+1)',
				...
				array('name'=>'first_name', 'header'=>Yii::t('administrators','coulmn_first_name'),'value'=>'$data->first_name'),
				array('name'=>'last_name', 'header'=>Yii::t('administrators','coulmn_last_name'),'value'=>'$data->last_name'),
				array('name'=>'email', 'header'=>Yii::t('administrators','coulmn_email'),'value'=>'$data->email'),
				array('name'=>'admin_role', 'header'=>Yii::t('administrators','coulmn_admin_role'),'value'=>'$data->adminrole->role'),
                array(
                'name'=>'status','header'=>Yii::t('administrators','coulmn_status'),
