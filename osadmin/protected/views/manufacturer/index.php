	...
	'columns'=>array(
     array(
        ...
        'value'=>'$this->grid->dataProvider->pagination->currentPage * $this->grid->dataProvider->pagination->pageSize + ($row+1)',
            ...
            array('name'=>'name','header'=>Yii::t('manufacturers','column_name'),'type'=>'raw'),
            array('name'=>'status','header'=>Yii::t('manufacturers','column_status'),
            'filter'=>CHtml::dropDownList('Manufacturer[status]', $_GET['Manufacturer']['status'],  
		...
		array('class'=>'bootstrap.widgets.TbButtonColumn',
                    ...
                    'buttons'=>array('update'=>array('label'=>$this->gridPerm[buttons][update][label], 'url'=>'Yii::app()->createUrl(Yii::app()->controller->id."/update/",array("backurl"=>base64_encode(urldecode(Yii::app()->request->requestUri)),"id"=>$data->id_manufacturer))'),'delete'=>array('url'=>' Yii::app()->createUrl(Yii::app()->controller->id."/delete/",array("backurl"=>base64_encode(urldecode(Yii::app()->request->requestUri)),"id"=>$data->id_manufacturer))')),
