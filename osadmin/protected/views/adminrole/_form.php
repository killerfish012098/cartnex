                        ...
                        <table  cellpadding="0" border="0" class="designs-forms">
                            <tbody>
                                <tr class="permissions-div">
                                    <td onclick=" $('.hide_box_line<?php echo $i; ?>').slideToggle();"><b>&nbsp;&nbsp;<?php echo Yii::t('common','menu_section_'.$k);?></b></td>
                                </tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" class="middle table">
                                            <tbody>
                                                ...
                                                <tr class="sub-links-div">
                                                    <td height="22" align="left" class="admin-role-div-name"><?php echo Yii::t('common','menu_item_'.$subV['file']['file_name']);?></td>
