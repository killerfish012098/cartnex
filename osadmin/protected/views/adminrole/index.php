    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView', array(
            ...
            'columns' => array(
                ...
                array('name' => 'role', 'header' => Yii::t('adminroles', 'coulmn_role'), 'value' => '$data->role'),
                array('name' => 'date_created', 'header' => Yii::t('adminroles', 'coulmn_date_created'), 'value' => '$data->date_created','filter'=>false),
                array('name' => 'date_modified', 'header' => Yii::t('adminroles', 'coulmn_date_modified'), 'value' => '$data->date_modified','filter'=>false),
                array(
                    'name' => 'status', 'header' => Yii::t('adminroles', 'coulmn_status'),
