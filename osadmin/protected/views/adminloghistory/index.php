...
$this->widget('bootstrap.widgets.TbExtendedGridView', array(
	...
	//'filter'=>$model,
        ...
        'value'=>'$this->grid->dataProvider->pagination->currentPage * $this->grid->dataProvider->pagination->pageSize + ($row+1)',
				...
				array('name' => 'first_name','header'=>yii::t('adminloghistories','column_first_name'),'value'=>'$data->first_name'),
				array('name' => 'last_name','header'=>yii::t('adminloghistories','column_last_name'),'value'=>'$data->last_name'),
				array('name' => 'role','header'=>yii::t('adminloghistories','column_role'),'value'=>'$data->role'),
				array('name' => 'access_date','header'=>yii::t('adminloghistories','column_access_date'),'value'=>'$data->access_date','filter'=>false),
				array('name' => 'page_accessed','header'=>yii::t('adminloghistories','column_page_accessed'),'value'=>array($this,'grid'),'filter'=>false,'type'=>'raw'),
				array('name' => 'action','header'=>yii::t('adminloghistories','column_action'),'value'=>'$data->action','filter'=>false),
				array('name' => 'ip_address','header'=>yii::t('adminloghistories','column_ip_address'),'value'=>'$data->ip_address','filter'=>false),
