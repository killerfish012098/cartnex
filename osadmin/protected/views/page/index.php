	...
	'columns'=>array(
     array(
        ...
        'value'=>'$this->grid->dataProvider->pagination->currentPage * $this->grid->dataProvider->pagination->pageSize + ($row+1)',
			...
			array('name'=>'title','header'=> Yii::t('pages','column_title'),'value'=>'$data->title'),
			array('name'=>'status', 'header'=>Yii::t('pages','column_status'),           
					'filter'=>CHtml::dropDownList('Page[status]', $_GET['Page']['status'],  
