...
<?php $this->widget('bootstrap.widgets.TbExtendedGridView', array(
	...
	'columns'=>array(
                ...
                array('name'=>'name','header'=>Yii::t('orderstatus','column_name'),'value'=>array($this,'grid'),"type"=>"raw"),
                array(
                    'header'=>'Action',
                    'class'=>'bootstrap.widgets.TbButtonColumn',
                    'htmlOptions'=>array('style'=>'min-width:50px;'),
                    'template'=>$this->gridPerm['template'],
                    'buttons'=>array('update'=>array('label'=>$this->gridPerm[buttons][update][label], 'url'=>'Yii::app()->createUrl(Yii::app()->controller->id."/update/",array("backurl"=>base64_encode(urldecode(Yii::app()->request->requestUri)),"id"=>$data->id_order_status))'),'delete'=>array('url'=>' Yii::app()->createUrl(Yii::app()->controller->id."/delete/",array("backurl"=>base64_encode(urldecode(Yii::app()->request->requestUri)),"id"=>$data->id_order_status))')),
                ),
	),
)); 
?>
