    ...
    <div class="span12 top_box_margin">
        ...
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'name', 'header' => yii::t('taxclasses','coulmn_name'), 'value' => '$data->name'),
                array('name' => 'description', 'header' => yii::t('taxclasses','coulmn_description'), 'value' => '$data->description','filter'=>false),
