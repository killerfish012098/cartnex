...
$this->widget('bootstrap.widgets.TbExtendedGridView', array(
	...
	'columns'=>array(
     array(
		...
		array('name'=>'name','header'=>Yii::t('stockstatus','column_name'),'value'=>'$data->name'),
		...
		array(
                    ...
                    'buttons'=>array('update'=>array('label'=>$this->gridPerm[buttons][update][label], 'url'=>'Yii::app()->createUrl(Yii::app()->controller->id."/update/",array("backurl"=>base64_encode(urldecode(Yii::app()->request->requestUri)),"id"=>$data->id_stock_status))'),'delete'=>array('url'=>' Yii::app()->createUrl(Yii::app()->controller->id."/delete/",array("backurl"=>base64_encode(urldecode(Yii::app()->request->requestUri)),"id"=>$data->id_stock_status))')),
