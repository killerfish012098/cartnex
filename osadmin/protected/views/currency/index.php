...
$this->widget('bootstrap.widgets.TbExtendedGridView', array(
	...
	'columns'=>array(
				...
				array('name'=>'name','header'=>Yii::t('currencies','column_name'),'value'=>'$data->name'),
				array('name'=>'code','header'=>Yii::t('currencies','column_code'),'value'=>'$data->code'),
                array(
                'name'=>'status','header'=>Yii::t('currencies','column_status'),
                'filter'=>CHtml::dropDownList('Currency[status]', $_GET['Currency']['status'],  
