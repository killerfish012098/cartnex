...
<?php $this->widget('bootstrap.widgets.TbExtendedGridView', array(
	...
	'filter'=>$model,
    'bulkActions' => array('actionButtons' => array( ),
		...
		'columns'=>array(
                array(
                   'header'=>Yii::t('reviews','column_number'),'value'=>'$this->grid->dataProvider->pagination->currentPage * $this->grid->dataProvider->pagination->pageSize + ($row+1)',
                 ),
				array('name'=>'product_name','header'=> Yii::t('reviews','column_product'),'value'=>'$data->product->name','filter'=>false),
				array('name'=>'customer_name','header'=> Yii::t('reviews','column_customer_name'),'value'=>'$data->customer_name'),
				array('name'=>'rating','header'=> Yii::t('reviews','column_rating'),'value'=>'$data->rating'),
				
				array('name'=>'status', 'header'=>Yii::t('reviews','column_status'),           
					'filter'=>CHtml::dropDownList('Review[status]', $_GET['Review']['status'],  
