...
<div class="span6 pull-left tb-breand"><?php echo "<a href='".$this->createUrl($this->uniqueid.'/index')."'>".Yii::t('common','menu_item_'.$this->uniqueid)."</a>"; echo $this->action->id!='index'?'<span class="iocn-main '.$this->action->id.'-icon"></span>':'';?>  </div>
