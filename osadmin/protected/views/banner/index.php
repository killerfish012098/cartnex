       ...
       <?php
        $this->widget('bootstrap.widgets.TbExtendedGridView',
            ...
            'columns' => array(
                ...
                array('name' => 'name', 'header' =>Yii::t('banners','column_name') , 'value' => '$data->name'),
				array('name'=>'status','header'=>Yii::t('banners','column_status'),	'filter'=>CHtml::dropDownList('Banner[status]', $_GET['Banner']['status'],array(''=>'All','1'=>'Enable','0'=>'Disable',)), 'value'=>'$data->status==1?"Enabled":"Disabled"'),
