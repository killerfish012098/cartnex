<div class=" Categories-inner-pages"> 
    <div class="categorie-detiles">
        <div class="heading-box "><h2><a href="<?php echo $data['brand']['href'] ?>"><?php echo $data['brand']['name'] ?></a></h2></div>
        <div class="col-md-2">
            <img src="<?php echo $data['brand']['image']; ?>"  alt="<?php echo $data['brand']['name'] ?>" title="<?php echo $data['brand']['name'] ?>" />
        </div>
        <div class="col-md-9"><p><?php echo $data['brand']['description'] ?></p></div>
                            ...
                            <div class="categort-position">
                                ...
                                <?php if (count($product['group']) > 0) { ?>
                                    ...
                                    <div class="left-block" >
                                        <div class="product-image-container col-md-3" id="three-<?php echo $i ?>">
                                            ...
                                            <div class="box-white-quck-lable">
                                                <?php
                                                $this->widget('bootstrap.widgets.TbButton', array('label' => Yii::t('common', 'button_quickview'),
                                                    'type' => '',
                                    ...
                                    <div class="right-block col-md-6" id="six-<?php echo $i ?>">
                                        ...
                                        $this->beginWidget('bootstrap.widgets.TbHeroUnit', array('heading' => $product['name'],
                                            'htmlOptions' => array(
        ...
        <?php $this->endWidget(); ?>
                 ...
                 <p class="price-div">
                                        ...
                                        <div class="main-review-div"> 
                                            ...
                                            <span class="add-to-my-wishlist col-md-6"> <span class="glyphicon glyphicon-heart"></span> <a style="cursor:pointer;" onclick="return addToWishList('<?php echo $product['product_id']; ?>')";><?php echo Yii::t('common', 'button_wishlist'); ?></a></span>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div><?php }?>
                                </div>
