...
<html lang="en">
    <head>
        ...
        <meta name="author" content="<?php echo $this->metatitle;?>" />
        ...
        <script type="text/javascript" src="<?php echo Yii::app()->params['config']['site_url']; ?>js/jquery.form.min.js"></script>
         <script src="<?php echo Yii::app()->params['config']['site_url'];?>js/jquery.scrollbox.js"></script>
        ...
        var product_list="<?php echo Yii::app()->config->getData('CONFIG_WEBSITE_ITEMS_PER_PAGE'); ?>";
            $(document).ready(function() { 
                    ...
                    function afterSuccess()
                    {
                            ...
                            url:'<?php echo $this->createUrl("product/imageupload");?>',
                            type: 'post',
                            data: '',
        ...
        <!-- <link rel="stylesheet" type="text/css" href="<?php //echo $baseUrl = Yii::app()->baseUrl.'/assets/9cc457d0/bootstrap/css/bootstrap.min.css';  ?>" /> -->  
        <?php //} ?>  
      </head>
    <body>
        <section id="header">
