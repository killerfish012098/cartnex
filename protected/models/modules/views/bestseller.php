<?php if(sizeof($data['products'])){?>
 ...
 $('#demo_bs').scrollbox({direction: 'h',distance: 134});
$('#demo5-backward_bs').click(function () {$('#demo_bs').trigger('backward');});
$('#demo5-forward_bs').click(function () { $('#demo_bs').trigger('forward'); });
});</script>
 <?php //echo '<pre>';print_r($data['products']);echo '</pre>';?>
	<div class="row col-md-12 sp-os">
        <div class="module-main-div">
            ...
            <div class="heading-box"><h2><?php echo Yii::t('modules','heading_title_bestsellers')?></h2></div>
           	<div class="module-content">
                <div class="product-latest-module">
               	  <div id="demo_bs" class="scroll-img">
      ...
      <button class="btn btn-inverse" id="demo5-backward_bs"><i class="glyphicon glyphicon-chevron-left"></i></button>
      <button class="btn btn-inverse" id="demo5-forward_bs"><i class="glyphicon glyphicon-chevron-right"></i></button>
    </div>
            </div>
        <div class="clearfix"></div>
        </div>
