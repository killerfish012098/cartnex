 ...
 $('#demo_re').scrollbox({direction: 'h',distance: 134});
$('#demo5-backward_re').click(function () {$('#demo_re').trigger('backward');});
$('#demo5-forward_re').click(function () { $('#demo_re').trigger('forward'); });
});</script>
 ...
 <?php //echo '<pre>';print_r($data['products']);echo '</pre>';?>
	<div class="row col-md-12 sp-os">
        <div class="module-main-div">
            ...
            <div class="heading-box"><h2><?php echo Yii::t('modules','heading_title_recentlyviewed')?></h2></div>
           	<div class="module-content">
                <div class="product-latest-module">
               	  <div id="demo_re" class="scroll-img">
      ...
      <button class="btn btn-inverse" id="demo5-backward_re"><i class="glyphicon glyphicon-chevron-left"></i></button>
      <button class="btn btn-inverse" id="demo5-forward_re"><i class="glyphicon glyphicon-chevron-right"></i></button>
    </div>
            </div>
        <div class="clearfix"></div>
        </div>
